...
export function getRealTimeData(reqBidsConfigObj, onDone, moduleConfig) {
  ...
  if (sids !== null) {
    setRealTimeData(reqBidsConfigObj, moduleConfig, {im_segments: parsedSids, im_uid: uid});
    onDone();
    alreadyDone = true;
  }
    ...
    success: function (response, req) {
      ...
      if (req.status === 200) {
        ...
        if (parsedResponse.segments) {
          setRealTimeData(reqBidsConfigObj, moduleConfig, {im_segments: parsedResponse.segments, im_uid: parsedResponse.uid});
